...
WebUI.setText(findTestObject('Object Repository/Daftar Siswa Kemenag/Page_Login/input_E-mail_css-11aywtz r-16y2uox r-crgep1_e0e620'), 
    GlobalVariable.User_kemenag_dki)

WebUI.setText(findTestObject('Object Repository/Daftar Siswa Kemenag/Page_Login/input_E-mail_css-11aywtz r-16y2uox r-crgep1_e0e620'), 
    GlobalVariable.Pass_sdtk_swasta)

WebUI.click(findTestObject('Object Repository/Daftar Siswa Kemenag/Page_Login/div_reCAPTCHA_recaptcha-checkbox-border'))

WebUI.delay(10)

WebUI.click(findTestObject('Page_EMIS_Login/div_Login'))
